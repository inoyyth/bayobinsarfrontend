...
<html xmlns="http://www.w3.org/1999/xhtml" lang="id" xml:lang="id">
    <head>
        ...
        <title>Bayo Binsar Official Website - <?php echo (isset($header_title) ? $header_title : 'Home Page');?></title>
        <meta name="description" content="<?php echo (isset($header_description) ? $header_description : 'Public speaking is the process of speaking to a group of people in a structured, deliberate manner intended to inform, influence, or entertain the listeners');?>">
        <meta name="DC.title" content="Bayo Binsar Official Website" />
        ...
        <meta itemprop="name" content="<?php echo (isset($header_title) ? $header_title : 'Home Page');?> - Bayo Binsar Official Website">
        <meta itemprop="description" content="<?php echo (isset($header_description) ? $header_description : 'Public speaking is the process of speaking to a group of people in a structured, deliberate manner intended to inform, influence, or entertain the listeners');?>">
		...
		<link rel="stylesheet" href="<?php echo base_url('assets/themes/css/bootstrap.min.css?'.date('YmdHis'));?>">
